...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsAppVue = __webpack_require__(72);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.hot.accept(["-!babel?optional[]=runtime&loose=all&nonStandard=false!./../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./app.vue","-!vue-html!./../../node_modules/vue-loader/lib/template-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=template&index=0!./app.vue"], function () {
	...
	var newTemplate = require("-!vue-html!./../../node_modules/vue-loader/lib/template-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=template&index=0!./app.vue")
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "#app[_v-78fbe970] {\n    height: 100%;\n  }\n\n  .editor[_v-78fbe970] {\n    height: 100%;\n    width: 100%;\n  }", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = {
	  ...
	  components: {
	    appEditor: __webpack_require__(78),
	    // if the name is header...it can not visible !!! why????
	    // so i changed the name to appHeader
	    appHeader: __webpack_require__(81)
	  },
	  methods: {
	    performHeaderAction: function performHeaderAction(action) {
	      switch (action) {
	        case 'format':
	          self.$broadcast('format-editor');
	          break;
	        default:
	          break;
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	hotAPI.install(require("vue"))
	if (!hotAPI.compatible) return
	var id = "-!babel?optional[]=runtime&loose=all&nonStandard=false!./../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./editor.vue"
	hotAPI.createRecord(id, module.exports)
	module.hot.accept(["-!babel?optional[]=runtime&loose=all&nonStandard=false!./../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./editor.vue","-!vue-html!./../../node_modules/vue-loader/lib/selector.js?type=template&index=0!./editor.vue"], function () {
	var newOptions = require("-!babel?optional[]=runtime&loose=all&nonStandard=false!./../../node_modules/vue-loader/lib/selector.js?type=script&index=0!./editor.vue")
	var newTemplate = require("-!vue-html!./../../node_modules/vue-loader/lib/selector.js?type=template&index=0!./editor.vue")
	hotAPI.update(id, newOptions, newTemplate)
	})
	})()
	}
...
/***/ function(module, exports) {
	...
	exports["default"] = {
	  ...
	  events: {
	    'format-editor': function formatEditor() {
	      var val = editor.session.getValue(); // get the json
...
/***/ function(module, exports) {
	...
	exports['default'] = {
	  ...
	  methods: {
	    menuClick: function menuClick(action) {
	      self.$dispatch('header-msg', action);
	    }
	  },
	  data: function data() {
	    return {};
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"toolbar toolbar-header\" id=\"header\">\n    <h1 class=\"title\">Web dev tools</h1>\n\n    <div class=\"toolbar-actions\">\n      <button class=\"btn btn-default\" v-on:click=\"menuClick('format')\">\n        <span class=\"icon icon-list\"></span>\n      </button>\n    </div>\n  </div>";

/***/ },
/* 84 */
/***/ function(module, exports) {

	module.exports = "<div id=\"app\" _v-78fbe970=\"\">\n    <app-header class=\"header\" v-on:header-msg=\"performHeaderAction\" _v-78fbe970=\"\"></app-header>\n    <app-editor class=\"editor\" _v-78fbe970=\"\"></app-editor>\n  </div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./photon.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./photon.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/stylus-loader/index.js!./shared.styl", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/stylus-loader/index.js!./shared.styl");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
